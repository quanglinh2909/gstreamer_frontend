...
import { getVisibleParkingLotPages } from "@/lib/parking-lot-view-model";
import { cn } from "./parking-lot-utils";

export function ParkingLotPagination({
    currentPage,
    totalPages,
    onPageChange,
}: {
    ...
    const visiblePages = getVisibleParkingLotPages(currentPage, totalPages);
    ...
    return (
        <nav aria-label="Phân trang bãi xe" className="flex flex-wrap items-center justify-center gap-2">
            <button
                type="button"
