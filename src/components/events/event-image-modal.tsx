...
export function EventImageModal({
    ...
    return (
        <div
            ...
            className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/75 p-2 backdrop-blur-sm sm:p-4"
        >
            <section
                role="dialog"
                aria-modal="true"
            ...
            >
                <header className="flex items-start justify-between gap-3 border-b border-slate-200 px-3 py-3 sm:gap-4 sm:px-5 sm:py-4">
                    <div className="min-w-0">
                        <p className="hidden text-xs font-semibold uppercase tracking-[0.12em] text-[#4369ee] sm:block">
                            {getEventPreviewTypeLabel(tab)}
                        </p>
                        <h2 className="truncate text-base font-semibold text-slate-950 sm:mt-1 sm:text-xl">
                            {resultLabel}
                        </h2>
                        <div className="mt-1 flex flex-wrap items-center gap-x-3 gap-y-0.5 text-xs text-slate-500 sm:mt-2 sm:gap-x-4 sm:gap-y-1 sm:text-sm">
                    ...
                    <button
                        ...
                        className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-slate-100 sm:h-10 sm:w-10 text-slate-600 transition-colors hover:bg-slate-200 hover:text-slate-950"
                    >
                        <X size={20} aria-hidden="true" />
                    </button>
                </header>

                <div className="relative min-h-[45vh] flex-1 bg-slate-950 sm:min-h-[480px]">
