...
import { getVisiblePlateWhiteListPages } from "@/lib/plate-white-list-view-model";
import { cn } from "./plate-white-list-utils";

export function PlateWhiteListPagination({
    currentPage,
    totalPages,
    onPageChange,
}: {
    ...
    const visiblePages = getVisiblePlateWhiteListPages(currentPage, totalPages);
    ...
    return (
        <nav aria-label="Phân trang biển số trắng" className="flex flex-wrap items-center justify-center gap-2">
            <button
                type="button"
